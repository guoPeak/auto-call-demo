    ...
    return (
        <Card>
            <Form form={serchForm} onFinish={onFinish} layout='inline'>
                ...
                <Form.Item>
                    <Button type='primary' loading={buttonLoading} htmlType="submit" style={{ marginRight: '16px', marginLeft: '30px' }}>查询</Button>
                    <Button type='primary' onClick={handleReset}>重置</Button>
                </Form.Item>
            </Form>
            <Button style={{ marginTop: '30px' }} onClick={newBot} type='primary'><PlusOutlined /> 新建</Button>
            ...
            <Modal title="Basic Modal" open={isModalOpen} onOk={handleOk} onCancel={handleCancel} okButtonProps={{ loading: modalLoading }}>
                <Form form={submitForm} labelCol={{ span: 4 }}>
                    <Form.Item label='Bot名称' name="name" rules={[{ required: true, message: '请输入Bot名称' }]}>
